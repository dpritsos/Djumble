...
class DSSVEM(object):
    ...
    def __init__(self,
        ...
        self.odc = offset_dcoefs
        self.ml_wg = ml_wg
        self.cl_wg = cl_wg
        self.fs_rnd_itrs = fs_rnd_itrs
        self.max_iter = max_iter
        self.lrate = lrn_rate

    def calc_dist_offsets(self, 
                          ctags,  # Array of the known and unknown Class tags. 0 means unknown.
                          dvectors,  # Array of data Vectors (documents originally).
                          kclstrs=0,  # The number of Clusters expected explicitly....
                                      # ...0 means implicitly calculated and closed-set assumption.    
                          ):

        pass

        # I think most of the work will be in this function...
    

    def fit(self, ctags, dvectors, kclstrs):
